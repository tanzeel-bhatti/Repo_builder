...
public class Constants {
	...
	public static String recommendationsOutputPath = "E:\\MS\\MSProject\\recommendationsOutputPath\\chess-board_" + Integer.toString(numberKeywordsThresh) +"_original_kwdwise.txt";
	...
	public static String stemmedName = "StemmedName";
	public static String originalName = "Name";
}
